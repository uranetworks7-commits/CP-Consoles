  ...
  return (
    <div className="min-h-screen bg-[#0a0c10] text-foreground selection:bg-primary selection:text-primary-foreground">
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-10 space-y-6">
        ...
        <section className="bg-card/10 rounded-2xl border border-border/30 overflow-hidden shadow-2xl">
        ...
        {/* Footer */}
        <footer className="pt-6 flex justify-between items-center text-muted-foreground/30">
